    ...
    */
    ...
    DA3F_lvl_prog = DA3F_lvl_prog + _DA3F_prog;
            ...
            if (DA3F_lvl_prog >= _DA3F_NextLvl) then {
               ...
               private _msg = format["<t font='PuristaMedium' size='0.8' color='#D3D3D3'>! Nouveau level !</t><br/><t font='PuristaMedium' size='0.8'  color='#16C500' >+ 1<br/>pour un total de : %1</t>",DA3F_lvl_Farm];
