    ...
    */
    ...
    while {true} do {
        _DA3F_Unit = player;
            ...
            profileNamespace setVariable ["DA3F_Stats_Lvl",[["DA3F_lvl_Farm","DA3F_lvl_prog"],[DA3F_lvl_Farm,DA3F_lvl_prog]]];
...
*/
        ...
        private _DA3F_Inv = (([_DA3F_Unit]call bis_fnc_invString) + (items _DA3F_Unit) + (assignedItems _DA3F_Unit) + (weapons _DA3F_Unit) + (magazines _DA3F_Unit));
            ...
            profileNamespace setVariable ["DA3F_Inventory_Unit",_DA3F_inventory];
